...
if __name__ == "__main__":
    ...
    with gr.Blocks() as demo:
        ...
        with gr.Tab("2 - Fine-tuning Carlo TTS Encoder"):
            ...
            with gr.Row():
                with gr.Column() as col1:
                    xtts_checkpoint = gr.Textbox(
                        label="CarloTTS checkpoint path:",
                        value="",
                    )
                    xtts_config = gr.Textbox(
                        label="CarloTTS config path:",
                        value="",
                    )

                    xtts_vocab = gr.Textbox(
                        label="CarloTTS vocab path:",
                        value="",
                    )
                    progress_load = gr.Label(label="Progress:")
                    load_btn = gr.Button(value="Step 3 - Load Fine-tuned CarloTTS model")
                ...
                with gr.Column() as col2:
                    ...
                    tts_text = gr.Textbox(
                        label="Input Text.",
                        value="Hi, my name is Carlo and I am from Italty, I am testing this TTS and output",
                    )
